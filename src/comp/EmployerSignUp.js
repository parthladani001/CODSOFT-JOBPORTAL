...
const EmployerSignUp = (props) => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            setLoading(true);
            await axios.post('http://localhost:5000/employerReg', { name, email, contact, password, key });
    ...
    return (
        <>
            ...
            <div className="container" style={{ backgroundColor: props.mode === 'light' ? 'white' : '#343a40', color: props.mode === 'light' ? 'black' : 'white' }}>
                <form name='employerSignUp'>
                    <div className="mb-3">
                        <h3 className='text-center'><img className="me-2 mb-2" src={adminRegisterLogo} alt="Logo" height="40" width="40" />Employer Registration</h3>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" placeholder='Create a new secret key ' className="form-control" id="key" onChange={(e) => setKey(e.target.value)} required={true} autoComplete='off' maxLength="50" />
                    </div>
                    ...
                    <center>
                        ...
                        <Link type="submit" role="button" className="btn btn-info w-100" id="backLogin" to={"/employerLogin"}>Back</Link>
                    </center>
                </form>
            </div>
        </>
